...
export default function LandingPage() {
  ...
  const sorted = [...filtered].sort((a, b) => {
    const va = sortKey === 'valuation' ? a.currentValuationM : sortKey === 'arr' ? a.arrM : median(a.forgePrice, a.hiivePrice, a.noticePrice);
    const vb = sortKey === 'valuation' ? b.currentValuationM : sortKey === 'arr' ? b.arrM : median(b.forgePrice, b.hiivePrice, b.noticePrice);
            ...
            {sorted.map((co, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <div style={{ textAlign: 'right', fontSize: 12, color: 'var(--txt2)', fontFamily: "'JetBrains Mono', monospace" }}>{fmtArr(co.arrM)}</div>
                  <div style={{ textAlign: 'right' }}>
                    <span style={{ fontSize: 12, fontWeight: 700, color: co.color, fontFamily: "'JetBrains Mono', monospace" }}>${blended.toFixed(2)}</span>
