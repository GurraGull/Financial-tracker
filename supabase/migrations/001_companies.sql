...
-- This creates the companies + secondary_prices tables, RLS policies, blended view, and seeds all 27 companies.
...
-- Median of all sources recorded in the last 30 days.
...
VALUES
  ...
  ('bytedance',   'ByteDance',     'BDNCE',   'Social / AI',         '#FF0050', 225000, '2023-12-01', 'Pre-IPO',   'TikTok and AI product suite.',                85000, 165, 170, 178, 'bytedance.com'),
  ('spacex',      'SpaceX',        'SPACEX',  'Aerospace',           '#3B82F6', 350000, '2024-12-01', 'Pre-IPO',   'Reusable rockets, Starlink, Mars.',           10200, 185, 192, 197, 'spacex.com'),
  ('stripe',      'Stripe',        'STRIPE',  'Fintech',             '#635BFF', 70000,  '2023-03-15', 'Pre-IPO',   'Global payments infrastructure.',             4800,  24,  26,  27,  'stripe.com'),
  ('shein',       'Shein',         'SHEIN',   'E-Commerce',          '#FF2E63', 66000,  '2023-05-01', 'Pre-IPO',   'Fast fashion e-commerce giant.',              32000, 38,  41,  43,  'shein.com'),
  ...
  ('xai',         'xAI',           'XAI',     'AI Foundation',       '#1DA1F2', 50000,  '2024-11-01', 'Series B',  'Grok AI and X platform AI.',                  1600,  40,  43,  45,  'x.ai'),
  ...
  ('chime',       'Chime',         'CHIME',   'Fintech',             '#00D3B8', 25000,  '2021-08-13', 'Series G',  'Mobile banking for everyone.',                2100,  30,  32,  34,  'chime.com'),
  ('ramp',        'Ramp',          'RAMP',    'Fintech',             '#F26419', 16000,  '2024-08-01', 'Series D',  'Corporate spend management.',                 520,   26,  28,  29,  'ramp.com'),
  ...
  ('klarna',      'Klarna',        'KLAR',    'Fintech',             '#FFB3C7', 14600,  '2024-07-01', 'Pre-IPO',   'Buy now pay later pioneer.',                  2400,  72,  75,  77,  'klarna.com'),
  ('scale-ai',    'Scale AI',      'SCALE',   'AI Infrastructure',   '#FF6B6B', 14000,  '2024-05-01', 'Series F',  'AI data labeling and infrastructure.',         780,   18,  20,  22,  'scale.com'),
  ('plaid',       'Plaid',         'PLAID',   'Fintech',             '#00B274', 13400,  '2021-04-01', 'Series D',  'Financial data connectivity.',                310,   12,  13,  14,  'plaid.com'),
  ('rippling',    'Rippling',      'RPPLG',   'HR & Payroll',        '#FF5E00', 13500,  '2024-04-22', 'Series F',  'HR, IT, and finance platform.',               370,   20,  22,  23,  'rippling.com'),
  ('figma',       'Figma',         'FIGMA',   'Design Tools',        '#F24E1E', 12500,  '2021-06-01', 'Pre-IPO',   'Collaborative design platform.',              780,   18,  20,  21,  'figma.com'),
  ('faire',       'Faire',         'FAIRE',   'B2B Commerce',        '#4CAF50', 12000,  '2022-01-11', 'Series G',  'Wholesale marketplace for retailers.',         720,   15,  17,  18,  'faire.com'),
  ('brex',        'Brex',          'BREX',    'Fintech',             '#FF6240', 12300,  '2022-01-11', 'Series D',  'Corporate cards and finance.',                310,   14,  15,  17,  'brex.com'),
  ('airtable',    'Airtable',      'AIRT',    'Productivity',        '#FCB400', 11000,  '2021-12-10', 'Series F',  'Low-code app-building platform.',             325,   12,  13,  15,  'airtable.com'),
  ...
  ('cohere',      'Cohere',        'COHR',    'AI Foundation',       '#39E09B', 5500,   '2024-07-22', 'Series D',  'Enterprise language AI platform.',            105,   18,  20,  21,  'cohere.com'),
